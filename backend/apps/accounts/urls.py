...
urlpatterns = [
    ...
    path("phone/request/", views.PhoneVerifyRequestView.as_view(), name="phone-verify-request"),
    path("phone/verify/", views.PhoneVerifyConfirmView.as_view(), name="phone-verify-confirm"),
